...
import image from "../Images/imageFirst.jpg";
...
//       formData.append(
//         "maxDownloads",
//         limitMode === "unlimited" ? -1 : maxDownloads
//       );
...
//       <h2>Upload File</h2>
//       <p style={styles.sub}>
//         Select a file to encrypt and get a secure shareable link
//       </p>
...
//             ...styles.limitBtn,
//             background:
//               limitMode === "limited" ? "#020617" : "#e5e7eb",
//             color:
//               limitMode === "limited" ? "#fff" : "#020617"
//           }}
//         >
...
//             ...styles.limitBtn,
//             background:
//               limitMode === "unlimited" ? "#020617" : "#e5e7eb",
//             color:
//               limitMode === "unlimited" ? "#fff" : "#020617"
//           }}
//         >
//           Allow Always Download
//         </button>
//       </div>
...
//                 ...styles.downloadLink,
//                 opacity:
//                   isExpired || isLimitReached ? 0.5 : 1,
//                 pointerEvents:
//                   isExpired || isLimitReached
//                     ? "none"
//                     : "auto"
...
//     textAlign: "center"
//   },
//   sub: { color: "#64748b", marginBottom: "16px" },
